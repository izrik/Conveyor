...
namespace Conveyor
{
     ...
     * See RFC 2616.
     */
        public static Dictionary<int, string> messagesByResponseCode = new Dictionary<int, string> {
            { 100, "Continue" },
     ...
     * See RFC 2616.
     */
        public static Dictionary<int, string> defaultBodiesByResponseCode = new Dictionary<int, string> {
